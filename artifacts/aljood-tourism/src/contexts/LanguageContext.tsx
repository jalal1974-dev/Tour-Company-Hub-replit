...
const translations = {
  ar: {
    ...
    navPackages: "جميع الباقات",
    pkgSearchTag: "استكشف واحجز",
    pkgSearchTitle: "ابحث في جميع الباقات",
    pkgSearchSubtitle: "Search All Packages",
    pkgSearchPlaceholder: "ابحث عن فندق...",
    pkgFilterDest: "الوجهة",
    pkgFilterAllDests: "جميع الوجهات",
    pkgFilterNights: "الليالي",
    pkgFilterAllNights: "كل المدد",
    pkgFilterStars: "النجوم",
    pkgFilterAllStars: "كل الفئات",
    pkgFilterMeal: "النظام الغذائي",
    pkgFilterAllMeals: "كل الأنظمة",
    pkgFilterMinPrice: "أدنى سعر (د.أ)",
    pkgFilterMaxPrice: "أعلى سعر (د.أ)",
    pkgSortLabel: "الترتيب",
    pkgSortPriceAsc: "السعر: الأقل أولاً",
    pkgSortPriceDesc: "السعر: الأعلى أولاً",
    pkgSortNightsAsc: "الليالي: الأقل أولاً",
    pkgSortNightsDesc: "الليالي: الأكثر أولاً",
    pkgResultCount: "باقة متاحة",
    pkgNoResults: "لا توجد باقات تطابق بحثك",
    pkgNoResultsSubtitle: "جرّب تعديل الفلاتر أو إزالتها",
    pkgResetAll: "مسح جميع الفلاتر",
    pkgLoadMore: "تحميل المزيد",
    pkgShowAll: "عرض جميع الباقات",
    pkgDestBadge: "الوجهة",
  ...
  en: {
    ...
    navPackages: "All Packages",
    pkgSearchTag: "Explore & Book",
    pkgSearchTitle: "Search All Packages",
    pkgSearchSubtitle: "جميع الباقات في مكان واحد",
    pkgSearchPlaceholder: "Search hotel name...",
    pkgFilterDest: "Destination",
    pkgFilterAllDests: "All Destinations",
    pkgFilterNights: "Nights",
    pkgFilterAllNights: "Any Duration",
    pkgFilterStars: "Stars",
    pkgFilterAllStars: "All Categories",
    pkgFilterMeal: "Meal Plan",
    pkgFilterAllMeals: "All Plans",
    pkgFilterMinPrice: "Min Price (JOD)",
    pkgFilterMaxPrice: "Max Price (JOD)",
    pkgSortLabel: "Sort by",
    pkgSortPriceAsc: "Price: Low to High",
    pkgSortPriceDesc: "Price: High to Low",
    pkgSortNightsAsc: "Nights: Fewest First",
    pkgSortNightsDesc: "Nights: Most First",
    pkgResultCount: "packages found",
    pkgNoResults: "No packages match your search",
    pkgNoResultsSubtitle: "Try adjusting or clearing your filters",
    pkgResetAll: "Clear All Filters",
    pkgLoadMore: "Load More",
    pkgShowAll: "Show All Packages",
    pkgDestBadge: "Destination",
